...
export const Products = () => {
  ...
  const metadata = {
    title: 'Products - New World Park Solutions',
    description:
      'Discover New World Park Solutions’ wide range of playground and park products. From play structures to park amenities, we provide safe and engaging outdoor solutions for communities across Ontario.',
    pathname: '/products',
  };

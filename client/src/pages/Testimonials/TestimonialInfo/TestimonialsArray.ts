...
export const TestimonialsArray: Testimonial[] = [
	{
		title:
			'Trevor Clapperton, Manager of Parks and Facilities, Township of Hamilton',
	...
	{
		title:
			'Karen McClintock, Director of Community Services (Pathways Children’s centre, Sarnia)',
	...
	{
		title:
			'Heidi Baillargeon, Project Manager and Landscape Architect (City of Windsor)',
		blurb: heidiBaillargeonBlurb,
		imageSrc: '/images/testimonials/heidi-baillargeon-testimonial.jpg',
	},
	{
		title:
			'Scott Nancekivell, Director of Facilities & Recreation Services (Township of Wilmot)',
		blurb: scottNancekivellBlurb,
		imageSrc: '/images/testimonials/scott-nancekivell-testimonial.jpg',
	},
	{
		title:
			'Joe Protulipac, VP – Operations (Croatian Sports & Community Centre of Hamilton Inc.)',
		blurb: joeProtulipacBlurb,
		imageSrc: '/images/testimonials/joe-protulipac-testimonial.jpg',
	},
	{
		title:
			'Deb Veccia, Supervisor Chatham Parks (Municipality of Chatham-Kent)',

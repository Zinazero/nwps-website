...
export const Store = () => {
  ...
  const metadata = {
    ...
    description:
      'Shop high-quality swing seats from New World Park Solutions. Durable, safe and designed to enhance playgrounds across Ontario.',
    pathname: '/store',
  };
      ...
      <div className="min-h-screen flex flex-col items-center px-6 py-12 relative">
        <div className="flex flex-col items-center w-full max-w-6xl">
          ...
          <img
            ...
            alt="New World Park Solutions Logo"
            className="w-50 mb-6"
          />

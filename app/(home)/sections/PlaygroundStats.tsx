import slideIcon from '@/app/assets/icons/slide-icon.png';
import seesawIcon from '@/app/assets/icons/seesaw-icon.png';
import swingIcon from '@/app/assets/icons/swing-icon.png';
import smileIcon from '@/app/assets/icons/smile-icon.png';
